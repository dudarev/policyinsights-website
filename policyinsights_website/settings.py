"""
Django settings for policyinsights_website project.
...
SECRET_KEY = ')&t+0a_k8*f!oh2h1w%makqck_#zw_3vrd!z6%%m6a4#sgafof'
...
ROOT_URLCONF = 'policyinsights_website.urls'
...
WSGI_APPLICATION = 'policyinsights_website.wsgi.application'
